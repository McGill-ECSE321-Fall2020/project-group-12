...
public class PostingService {
    ...
    /**
     * Creates a Posting with its attributes passed as parameters and
     * saves the Posting, its Artist and its Gallery to their respective repositories.
     *
    ...
    public Posting deletePosting(Posting posting) {
        if (posting == null)
            throw new NullPointerException("Cannot remove null posting, perhaps it has already been deleted");
