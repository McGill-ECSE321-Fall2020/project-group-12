...
public class PurchaseRestController {
    ...
    /**
     * Gets a list of all Purchases after an HTTP request
     * and puts into HTTP response in JSON or XML.
    ...
    /**
     * Gets a Purchase by its purchase ID after an HTTP request
    ...
    /**
     * Gets a list of all Purchases by a Buyer after an HTTP request
    ...
    /**
     * Gets the cart of a Buyer after an HTTP request
     * and puts into the HTTP response as JSON or XMl.
     * @param email: the email of the Buyer.
    ...
    /**
     * Creates a purchase from Dto data after an HTTP request
     * and puts into an HTTP response as JSON or XML.
    ...
    /**
     * Makes a Purchase from Dto data and delivery type after an HTTP request
     * and puts into HTTP response as JSON or XML.
     * @param data: the data from PurchaseDto.
    ...
    /**
     * Cancels a Purchase using Dto data after an HTTP request
     * and puts into HTTP response as JSON or XMl.
     * @param data: the data from PurchaseDto
    ...
    /**
     * Adds a Posting to a Buyer's cart after an HTTP request
     * and puts into HTTP response as JSON or XML.
    ...
    /**
     * Removes a Posting from a Buyer's cart after an HTTP request
     * and puts into an HTTP request as JSON or XML.
     * @param buyerData: the data from BuyerDto.
