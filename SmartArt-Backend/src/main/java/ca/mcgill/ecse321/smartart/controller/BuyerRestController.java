...
public class BuyerRestController {
    ...
    /**
     * Gets a list of all the Buyers after HTTP request and puts into the HTTP response as JSON or XMl.
    ...
    /**
     * Gets a Buyer by his email after HTTP request
    ...
    /**
     * Creates a Buyer by their Dto data after HTTP request
     * and puts into the HTTP response as JSON or XMl.
